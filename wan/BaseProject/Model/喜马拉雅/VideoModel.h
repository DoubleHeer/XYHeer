...
#import "BaseModel.h"
@class VideoVideoSidListModel;
@class VideoVideoListModel;
...
/*
 对头文件属性检查
 1.检查有没有数组
 2.检查有没有系统关键词属性，如果是使用Json Accesony自动生成，这个工具会自动把系统关键词 换名称
 3.检查命名是否由服务器传入key进行了一定规律的修改，java服务器人员经常串key形式：MP4_url,iOS喜欢驼峰 mp4Url
 */
...
@property (nonatomic, strong) NSString *desc;//key改
