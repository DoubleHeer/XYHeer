...
@interface SumAbilityViewController ()<UICollectionViewDelegateFlowLayout,UICollectionViewDataSource,UICollectionViewDelegate>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.titleLb.text = [self.saVM nameForRow:indexPath.row];
    [cell.image.imageView setImageWithURL:[self.saVM iconURLForRow:indexPath.row] placeholderImage:[UIImage imageNamed:@"cell_bg_noData_2"]];
    return cell;
}
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    SumAbilityDetailController *vc = [[SumAbilityDetailController alloc]initWithRow:indexPath.row SumAbilityViewModel:self.saVM];
