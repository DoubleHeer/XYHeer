...
@class MusicCategoryAlbumModel,MusicCategoryTracksModel,MusicCategoryTracksListModel;

@interface MusicCategoryModel : BaseModel

@property (nonatomic, strong) MusicCategoryTracksModel *tracks;

@property (nonatomic, strong) MusicCategoryAlbumModel *album;
...
@interface MusicCategoryAlbumModel : NSObject
...
@interface MusicCategoryTracksModel : NSObject

@property (nonatomic, assign) NSInteger maxPageId;

@property (nonatomic, strong) NSArray<MusicCategoryTracksListModel *> *list;
...
@interface MusicCategoryTracksListModel : NSObject
